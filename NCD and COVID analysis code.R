...
COVID_data      <- read_csv("C:/Users/Admin/Dropbox/Causal Insights/EIC/COVID Data/COVID_data.csv")
...
NCD_data <- read_csv("C:/Users/Admin/Dropbox/Causal Insights/EIC/COVID Data/GBDdata.csv")
...
Country_Info_data <- read_csv("C:/Users/Admin/Dropbox/Causal Insights/EIC/COVID Data/Country_info.csv")
Country_Info_data <- subset(Country_Info_data, countryid %in% List_countryid)

#Import age and sex data
Age_Sex_data <- read_csv("C:/Users/Admin/Dropbox/Causal Insights/EIC/COVID Data/age_and_sex.csv")
...
Test_data <- read_csv("C:/Users/Admin/Dropbox/Causal Insights/EIC/COVID Data/cumulative tests.csv")
...
#Export to CSV
write.csv(Cont_Sum, file="descriptive_results.csv")
